...
function TestSection({
  ...
  return (
    <section className={cn("flex flex-col", className)}>
      ...
      <div
        className={cn(
          "rounded-medium relative mt-2 min-h-[140px] overflow-hidden border p-2 dark:border-gray-600",
...
const Box = forwardRef(
  (
    ...
    return (
      <div
        className={cn(`bg-warning-500 relative h-5 w-5 rounded-[6px] text-[0.7rem]`, className)}
        ref={ref}
      >
